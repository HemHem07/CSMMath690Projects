...
class Win:
    def __init__(self,xMin,xMax,yMin,yMax,radius,increment):
        self.win = Tk()
    ...
    def setup(self):
        ...
        self.circle = Circle(self.canvas,self.convert,self.radius,self.increment)
        self.xAxis = xAxis(self.canvas,self.convert) 
        self.yAxis = yAxis(self.canvas,self.convert)
        self.point = Point(self.canvas,self.convert,self.circle)
        self.diameter = Diameter(self.canvas,self.convert,self.circle)
...
class Circle:
    def __init__ (self, canvas, xysystem, radius,increment):
        self.radius = radius
        self.convert = xysystem
        self.canvas = canvas
        self.x1 = -self.radius 
        self.y1 = 2*self.radius 
        self.x2 = self.radius 
        self.y2 = 0
        self.h1 = self.convert.xtoh(self.x1)
        self.v1 = self.convert.ytov(self.y1)
        self.h2 = self.convert.xtoh(self.x2)
        self.v2 = self.convert.ytov(self.y2)
        self.increment = increment
...
class Point:
    def __init__(self, canvas, xysystem, circle):
        self.canvas = canvas 
        self.convert = xysystem 
        self.circle = circle
...
r = 1.5
inc = 0.3
x = Win(xMin,xMax,yMin,yMax, r,inc)
x.win.mainloop()